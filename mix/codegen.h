...
class CodeGenerator {
 ...
 public:
  ...
  Location *GenTempVar(FrameAllocator *falloc);
  ...
  Location *GenLoadConstant(FrameAllocator *falloc, int value);
  Location *GenLoadConstant(FrameAllocator *falloc, const char *str);
  Location *GenLoadLabel(FrameAllocator *falloc, const char *label);
  ...
  Location *GenLoad(FrameAllocator *falloc, Location *addr, int offset = 0);
  ...
  Location *GenLCall(FrameAllocator *falloc, const char *label,
  ...
  Location *GenACall(FrameAllocator *falloc, Location *fnAddr,
                     bool fnHasReturnValue);
